...
function DesktopLayout() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 text-base">
      {/* Language Toggle */}
            ...
            <Card className="shadow-lg">
              <CardContent className="p-6 space-y-6 text-center">
                ...
                <div>
                  ...
                  <ol className="text-base text-gray-600 text-left list-decimal pl-6 space-y-2">
                    {language === 'en' ? (
                      <>
